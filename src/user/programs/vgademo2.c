/**
 * VGA 256-Color Mode Demo
 * Demonstrates VGA mode 13h (320x200) and mode X (320x240)
 * 
...
/**
 * Draw a plasma-like pattern (mode 13h)
 */
static void draw_plasma_13h(void) {
    int x, y;
...
/**
 * Draw concentric circles (mode X)
 */
static void draw_circles_x(void) {
...
/**
 * Demo Mode 13h (320x200, 256 colors)
 */
static void demo_mode_13h(void) {
    print("Initializing VGA Mode 13h (320x200, 256 colors)...\n");
...
/**
 * Demo Mode X (320x240, 256 colors)
 */
static void demo_mode_x(void) {
    print("Initializing VGA Mode X (320x240, 256 colors)...\n");
    print("Press any key to continue...\n");
    getchar();
    ...
    /* Draw gradient */
    draw_gradient(GFX_WIDTH_X, GFX_HEIGHT_X);
 ...
 */
void _start(void) {
    print("=== VGA 256-Color Mode Demo ===\n\n");
    print("This demo showcases VGA Mode 13h and Mode X.\n");
